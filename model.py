...
unique_train_labels, train_counts = torch.unique(Y_train, return_counts=True)
unique_test_labels, test_counts = torch.unique(Y_test, return_counts=True)

print(f"Training class labels: {unique_train_labels}")
print(f"Training class counts: {train_counts}")

print(f"Test class labels: {unique_test_labels}")
